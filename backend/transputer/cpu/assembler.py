...
class Assembler:
  def __init__(self):
    self.cd = {
      ...
      'ANC': (CPU.logicalAnd, ((Param.REG,), (Param.REG, Param.LOC, Param.C8))),
      'NAC': (CPU.logicalNand, ((Param.REG,), (Param.REG, Param.LOC, Param.C8))),
      'ORC': (CPU.logicalOr, ((Param.REG,), (Param.REG, Param.LOC, Param.C8))),
      'XRC': (CPU.logicalXor, ((Param.REG,), (Param.REG, Param.LOC, Param.C8))),
