...
and zeroes will never be included in the real input.''',
  ...
  Task(
    'sorting-1',
    'Sorting', 
    'Sort the input list, and output from lowest to highest.',
    [194, 71, 245, 77, 52, 54, 20, 240],
    [20, 52, 54, 71, 77, 194, 240, 245],
    [3, 69, 98, 97, 185, 140, 95, 116],
    [3, 69, 95, 97, 98, 116, 140, 185]),
  Task(
    'sorting-2',
    'Even More Sorting', 
    'Sort the input list, and output from lowest to highest. A lot like the earlier sorting problem - but keep track of your memory usage!',
    [173, 132, 31, 68, 229, 145, 97, 36, 239, 75, 89, 240, 245, 123, 209, 176],
    [31, 36, 68, 75, 89, 97, 123, 132, 145, 173, 176, 209, 229, 239, 240, 245],
    [166, 143, 62, 140, 25, 66, 118, 213, 23, 22, 130, 136, 8, 111, 181, 12],
    [8, 12, 22, 23, 25, 62, 66, 111, 118, 130, 136, 140, 143, 166, 181, 213]),
  Task(
    '',
    'None', 
    '',
